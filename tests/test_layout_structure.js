...
test("calculator page uses tabbed workspace layout with drawers and upload modal", () => {
  ...
  assert.match(indexHtml, /id="workspaceTabDefaultRecipes"/);
  ...
  assert.match(indexHtml, /id="defaultRecipeWorkspacePanel"/);
  ...
  assert.match(indexHtml, /id="openDefaultRecipePathsDrawer"/);
  assert.match(indexHtml, /id="defaultRecipePathsDrawer"/);
